...
from .views import DaisyUILoginView, DaisyUIRegisterView, CreateBlogPostView, ViewBlogPostsViews, BlogPostUpdateView, BlogPostDeleteView
...
urlpatterns = [
    ...
    path('create-blog/', CreateBlogPostView.as_view(), name='create'),
